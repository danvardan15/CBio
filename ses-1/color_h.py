...
def color_h3(selection='all'):
        s = str(selection)
        print(s)
        cmd.set_color("color_phe2",[0, 0, 1])
        cmd.set_color("color_ile2",[0, 0, 1])
        cmd.set_color("color_val2",[0, 0, 1])
        cmd.set_color("color_leu2",[0, 0, 1])
        cmd.set_color("color_trp2",[0, 0, 1])
        cmd.set_color("color_met2",[0, 0, 1])
        cmd.set_color("color_ala2",[0, 0, 1])
        cmd.set_color("color_gly2",[1, 0, 0])
        cmd.set_color("color_tyr2",[0, 0, 1])
        cmd.set_color("color_cys2",[0, 0, 1])
        cmd.set_color("color_pro2",[0, 0, 1])
        cmd.set_color("color_thr2",[0, 0, 1])
        cmd.set_color("color_ser2",[0, 0, 1])
        cmd.set_color("color_his2",[0, 0, 1])
        cmd.set_color("color_glu2",[0, 0, 1])
        cmd.set_color("color_asn2",[0, 0, 1])
        cmd.set_color("color_gln2",[0, 0, 1])
        cmd.set_color("color_asp2",[0, 0, 1])
        cmd.set_color("color_lys2",[0, 0, 1])
        cmd.set_color("color_arg2",[0, 0, 1])
        cmd.color("color_ile2","("+s+" and resn ile)")
        cmd.color("color_phe2","("+s+" and resn phe)")
        cmd.color("color_val2","("+s+" and resn val)")
        cmd.color("color_leu2","("+s+" and resn leu)")
